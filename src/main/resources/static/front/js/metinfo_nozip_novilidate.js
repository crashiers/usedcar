...
var lazyloadbg_set = $('input[name=lazyloadbg]').val(), lazyloadbg = lazyloadbg_set ? '/images/loading.gif': '/images/loading.gif', lazyloadbg_base64 = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC";
if ( !! window.ActiveXObject || "ActiveXObject" in window || is_ucbro || lazyloadbg == 'base64') lazyloadbg = lazyloadbg_base64; (function($, window, document, undefined) {
    var $window = $(window);
    ...
    function(a, b, c, d) {
        ...
        function e(b, d) {
            if (this.el = b, this.$el = a(b), this.s = a.extend({},
                    f, d), this.s.dynamic && "undefined" !== this.s.dynamicEl && this.s.dynamicEl.constructor === Array && !this.s.dynamicEl.length) throw "When using dynamic mode, you must also define dynamicEl as an Array.";
            return this.modules = {},
                this.lGalleryOn = !1,
                this.lgBusy = !1,
        ...
        e.prototype.init = function() {
            ...
            e.prototype.loadContent = function(c, d, e) {
                ...
                l.$slide.eq(c).find(".lg-object").on("load.lg error.lg",
                    function() {
                        var b = 0;
                ...
                d === !0 && (l.$slide.eq(c).hasClass("lg-complete") ? l.preload(c) : l.$slide.eq(c).find(".lg-object").on("load.lg error.lg",
                    function() {
                        l.preload(c)
                    }))
            },
            e.prototype.slide = function(b, c, d) {
                ...
                if (!f.lGalleryOn || e !== b) {
                    ...
                    if (!f.lgBusy) {
                        ...
                        } else f.$outer.addClass("lg-no-trans"),
            ...
            e.prototype.keyPress = function() {
                var c = this;
                this.$items.length > 1 && a(b).on("keyup.lg",
                    function(a) {
            ...
            e.prototype.arrowDisable = function(a) { ! this.s.loop && this.s.hideControlOnEnd && (a + 1 < this.$slide.length ? this.$outer.find(".lg-next").removeAttr("disabled").removeClass("disabled") : this.$outer.find(".lg-next").attr("disabled", "disabled").addClass("disabled"), a > 0 ? this.$outer.find(".lg-prev").removeAttr("disabled").removeClass("disabled") : this.$outer.find(".lg-prev").attr("disabled", "disabled").addClass("disabled"))
            },
            ...
            e.prototype.enableSwipe = function() {
                var a = this,
                    ...
                    c = 0,
                    d = !1;
                a.s.enableSwipe && a.isTouch && a.doCss() && (a.$slide.on("touchstart.lg",
                    function(c) {
            ...
            e.prototype.enableDrag = function() {
                var c = this,
                    ...
                    f = !1,
                    g = !1;
                c.s.enableDrag && !c.isTouch && c.doCss() && (c.$slide.on("mousedown.lg",
                    function(b) {
        ...
        var e = {
            ...
            f = function(b) {
                ...
                !(this.core.$items.length < 2) && (this.core.s = a.extend({},
                    e, this.core.s), this.interval = !1, this.fromAuto = !0, this.canceledOnTouch = !1, this.fourceAutoplayTemp = this.core.s.fourceAutoplay, this.core.doCss() || (this.core.s.progressBar = !1), this.init(), this)
            };
        ...
        f.prototype.init = function() {
            ...
            f.prototype.build = function() {
                function c(a, b, c) {
                    var d, h = e.core.isVideo(a, c) || {},
                        i = "";
                    h.youtube || h.vimeo || h.dailymotion ? h.youtube ? d = e.core.s.loadYoutubeThumbnail ? "//img.youtube.com/vi/" + h.youtube[1] + "/" + e.core.s.youtubeThumbSize + ".jpg": b: h.vimeo ? e.core.s.loadVimeoThumbnail ? (d = "//i.vimeocdn.com/video/error_" + g + ".jpg", i = h.vimeo[1]) : d = b: h.dailymotion && (d = e.core.s.loadDailymotionThumbnail ? "//www.dailymotion.com/thumbnail/video/" + h.dailymotion[1] : b) : d = b,
                ...
                if (e.core.$outer.addClass("lg-has-thumb"), e.core.$outer.find(".lg").append(h), e.$thumbOuter = e.core.$outer.find(".lg-thumb-outer"), e.thumbOuterWidth = e.$thumbOuter.width(), e.core.s.animateThumb && e.core.$outer.find(".lg-thumb").css({
                        ...
                        position: "relative"
                    }), this.core.s.animateThumb && e.$thumbOuter.css("height", e.core.s.thumbContHeight + "px"), e.core.s.dynamic) for (var i = 0; i < e.core.s.dynamicEl.length; i++) c(e.core.s.dynamicEl[i].src, e.core.s.dynamicEl[i].thumb, i);
                ...
                e.core.$outer.find(".lg-thumb").html(f),
                    ...
                    d.on("click.lg touchend.lg",
                        function() {
                            var b = a(this);
                            setTimeout(function() { (e.thumbClickable && !e.core.lgBusy || !e.core.doCss()) && (e.core.index = b.index(), e.core.slide(e.core.index, !1, !0))
                                },
                                50)
                        }),
                    e.core.$el.on("onBeforeSlide.lg.tm",
                    ...
                    a(b).on("resize.lg.thumb orientationchange.lg.thumb",
                        function() {
                            setTimeout(function() {
                                    e.animateThumb(e.core.index),
            ...
            f.prototype.enableThumbDrag = function() {
                ...
                c.$thumbOuter.addClass("lg-grab"),
                    c.core.$outer.find(".lg-thumb").on("mousedown.lg.thumb",
                        function(a) {
                            c.thumbTotalWidth > c.thumbOuterWidth && (a.preventDefault(), d = a.pageX, f = !0, c.core.$outer.scrollLeft += 1, c.core.$outer.scrollLeft -= 1, c.thumbClickable = !1, c.$thumbOuter.removeClass("lg-grab").addClass("lg-grabbing"))
                        }),
                    a(b).on("mousemove.lg.thumb",
                        function(a) {
    ...
    function(a, b, c, d) {
        ...
        f.prototype.init = function() {
            ...
            b.core.doCss() && b.core.$items.length > 1 && (b.core.s.enableSwipe && b.core.isTouch || b.core.s.enableDrag && !b.core.isTouch) ? b.core.$el.on("onSlideClick.lg.tm",
                function() {
    ...
    function(a, b, c, d) {
        ...
        f.prototype.init = function() {
            ...
            c.core.s.actualSize && (d += '<span id="lg-actual-size" class="lg-icon"></span>'),
                ...
                c.core.$el.on("onSlideItemLoad.lg.tm.zoom",
                    function(b, d, e) {
            ...
            var e = 1,
                ...
                i = !1;
            c.core.$el.on("onAferAppendSlide.lg.tm.zoom",
                function(a, b) {
                ...
                a(b).on("resize.lg.zoom scroll.lg.zoom orientationchange.lg.zoom",
                    function() {
                        c.pageX = a(b).width() / 2,
                ...
                c.core.$el.on("onBeforeSlide.lg.tm",
                    function() {
                        e = 1,
                            c.resetZoom()
                    }),
            ...
            f.prototype.zoomDrag = function() {
                var c = this,
                    ...
                    h = !1,
                    i = !1;
                c.core.$slide.on("mousedown.lg.zoom",
                    function(b) {
                        ...
                        c.core.$outer.hasClass("lg-zoomed") && a(b.target).hasClass("lg-object") && (h || i) && (b.preventDefault(), d = {
                            x: b.pageX,
                            y: b.pageY
                        },
                            f = !0, c.core.$outer.scrollLeft += 1, c.core.$outer.scrollLeft -= 1, c.core.$outer.removeClass("lg-grab").addClass("lg-grabbing"))
                    }),
                    a(b).on("mousemove.lg.zoom",
                        function(a) {
                            if (f) {
                    ...
                    a(b).on("mouseup.lg.zoom",
                        function(a) {
                            f && (f = !1, c.core.$outer.removeClass("lg-zoom-dragging"), !g || d.x === e.x && d.y === e.y || (e = {
                                x: a.pageX,
                                y: a.pageY
                            },
                                c.touchendZoom(d, e, h, i)), g = !1),
                                c.core.$outer.removeClass("lg-grabbing").addClass("lg-grab")
                        })
            },
            f.prototype.touchendZoom = function(a, b, c, d) {
                var e = this,
                    ...
                    m = Math.abs(g.outerWidth() * Math.abs(g.attr("data-scale")) - e.core.$outer.find(".lg").width() + l); (Math.abs(b.x - a.x) > 15 || Math.abs(b.y - a.y) > 15) && (d && (i <= -k ? i = -k: i >= -j && (i = -j)), c && (h <= -m ? h = -m: h >= -l && (h = -l)), d ? f.attr("data-y", Math.abs(i)) : i = -Math.abs(f.attr("data-y")), c ? f.attr("data-x", Math.abs(h)) : h = -Math.abs(f.attr("data-x")), f.css({
                    left: h + "px",
                    top: i + "px"
                }))
            },
    ...
    function(a, b, c, d) {
        ...
        f.prototype.init = function() {
            var c, d = this;
            d.core.$el.on("onAfterSlide.lg.tm",
                function(a, c, e) {
                    b.location.hash = "lg=" + d.core.s.galleryId + "&slide=" + e
                }),
                a(b).on("hashchange.lg.hash",
                    function() {
                        c = b.location.hash;
    ...
    function(t) {
        ...
        r._update = function(i, n) {
            ...
            t(window).bind("resize orientationchange",
                function(t) {
                    r._update(!0, t)
                })
    ...
    function(a) {
        ...
        b = function() {
            ...
            b.prototype.lazyLoad = function() {
                function g(c) {
                    a("img[data-lazy]", c).each(function() {
                        ...
                        e.onerror = function() {
                            c.removeAttr("data-lazy").removeAttr("data-srcset").removeClass("slick-loading").addClass("slick-lazyload-error"),
            ...
            b.prototype.loadSlider = function() {
                var a = this;
                if (a.options.placeHolder) a.$slideTrack.find('img[data-lazy]').attr({
...
var met_prevArrow = '<button type="button" class="slick-prev"><i class="icon pe-angle-left vertical-align-middle"></button>',
    met_nextArrow = '<button type="button" class="slick-next"><i class="icon pe-angle-right vertical-align-middle"></i></button>';$(document).ready(function() {
...
$(document).ready(function() {
    ...
    if ($(".met-img-showbtn").length) {
        $(document).on('click', ".met-img-showbtn",
            function() {
...
$(document).ready(function() {
    ...
    if ($(met_img_carousel_slide).length > 1) {
        ...
        $(met_img_carousel).on('beforeChange',
    ...
    if ($(showprotype2).length) {
        ...
        $(document).on('click', showprotype2 + ' .navbar .navbar-right li a',
            function(e) {
                e.preventDefault();
                var thisobj = $(this),
        ...
        $(showprotype2 + ' .navbar .navbar-toggle').one("click",
            function() {
                setTimeout(function() {
                        navtabSwiper(".met-showproduct-navtabs");
                    },
...
$(document).ready(function() {
    ...
    function addVideo(obj) {
        if ($(obj + '[data-toggle=modal]').length) {
            $('body').append('<div class="modal fade modal-fall vertical-align" id="modal-video" aria-hidden="true"   role="dialog" tabindex="-1" style="display: none; padding-right: 17px;"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="icon pe-close" aria-hidden="true"></i></button><video controls  class="met-video modal-dialog vertical-align-middle">video</video></div>');
    ...
    Breakpoints.on('md lg', {
        enter: function() {
            imageloadFun('.display-slick img',
                function() {
